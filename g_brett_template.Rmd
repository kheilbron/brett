...
for( i in seq_len( NROW(peaks) ) ){
  ...
  locus_subheading <- paste0( "\n## Locus ", i, ": ", peaks$SNP[i], " (", peaks$NEAREST_GENE[i], ")")
  cat(locus_subheading)
  library(knitr)
  
  # Insert the POPS subheading and plot
  cat("\n### POPS")
  pops_locus_plot <- file.path( "plots", "pops", paste0( "region_", i, "_", peaks$SNP[i], ".jpg" ) )
  # include_graphics(pops_locus_plot)
  
  # Insert the MAGMA subheading and plot
  cat("\n### MAGMA")
  mag_locus_plot <- file.path( "plots", "magma", paste0( "region_", i, "_", peaks$SNP[i], ".jpg" ) )
