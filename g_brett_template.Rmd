...
# Loop through peaks
opeaks <- peaks[ order( peaks$CHR, peaks$BP ) , ]
for( i in seq_len( NROW(opeaks) ) ){
  
  # Set up the sub-heading for the locus
  locus_subheading <- paste0( "\n## Locus ", i, ": ", opeaks$SNP[i], " (", 
                              opeaks$NEAREST_GENE[i], ") {.tabset .tabset-pills}\n")
  cat(locus_subheading)
  
  # Insert the POPS subheading and plot
  cat("\n### POPS\n")
  pops_locus_plot <- file.path( "plots", "pops", 
                                paste0( "region_", i, "_", opeaks$SNP[i], ".jpg" ) )
  # cat( "\n", pops_locus_plot, "\n" )
