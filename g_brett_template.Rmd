...
for( i in seq_len( NROW(peaks) ) ){
  ...
  locus_subheading <- paste0( "## Locus ", i, ": ", peaks$snp[i], " (", peaks$NEAREST_GENE, ")")
  cat(locus_subheading)
  library(knitr)
  
  # Insert the POPS subheading and plot
  cat("### POPS")
  pops_locus_plot <- file.path( maindir, "plots", "pops", paste0( "region_", i, "_", peaks$SNP[i], ".jpg" ) )
  include_graphics(pops_locus_plot)
  
  # Insert the MAGMA subheading and plot
  cat("### MAGMA")
  mag_locus_plot <- file.path( maindir, "plots", "magma", paste0( "region_", i, "_", peaks$SNP[i], ".jpg" ) )
