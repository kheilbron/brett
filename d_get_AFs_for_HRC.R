...
rare_outfile     <- file.path( scratch_dir, "hrc_eur_snps_mac_ge_10.tsv" )
common_outfile   <- file.path( scratch_dir, "hrc_eur_snps_maf_ge_0.01.tsv" )
...
rare_home_dir_file   <- "/home/heilbron/projects/pops/data/hrc_eur_snps_mac_ge_10.tsv"
common_home_dir_file <- "/home/heilbron/projects/pops/data/hrc_eur_snps_maf_ge_0.01.tsv"
